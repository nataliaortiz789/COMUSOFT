...
<html lang="es" dir="ltr">
  ...
  <body>
    ...
    <div class="container" align="center" style="margin-top:50px">
      <h3 class="text-danger">CONVOCATORIAS ACTIVAS</h3>
      <div class="">
          ...
          <tbody>
            ...
            if($correcto){
              foreach ($resultado as $det){
                ...
                echo("<td align='center'><a href='crearPostulacion.php?convocatoria=".$det['id']."'><img src='../imagenes/bookmark-plus-black.svg' height='20'></a></td>");
                echo "</tr>";
                }
            }
